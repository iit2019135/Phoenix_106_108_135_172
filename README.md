...
Department of Information Technology
 “In partial fulfillment of the requirements for the Software Engineering Course in Information Technology Programme”
...
Class diagram explanation		…	…	…	…	…	 9
State diagram explanation		…	…	…	…	…	 9
Sequence diagram explanation	…	…	…	…	…	10
Activity  diagram explanation		…	…	…	…	…	11

Other description	…	…	…	…	…	…	…	…	12

Execution architecture				…	…	…	…	12
Reuse and relationship to other products	…	…	…	…	12

Design decision and tradeoffs 	…	…	…	…	…	…	13

Pseudocode for components	…	…	…	…	…	…	14

Room pseudocode		 	…	…	…	…	…	14
Enter the weather data pseudocode	…	…	…	…	…	14
Devices state pseudocode 		…	…	…	…	…	15
Edit devices pseudocode 		…	…	…	…	…	15
Remove device pseudocode 		…	…	…	…	…	16
Add device pseudocode 		…	…	…	…	…	16
...
This SDS is divided into seven sections with various sub-sections. The
...
Following given is the pseudo code of various methods described in various
classes. This section is really helpful for both, the user and the owner as the
user is able to get the deep insight of the code of the software without paying
much heed to the code itself. Also it is beneficial to the owner as it provides
a clear insight while developing the project and helps a lot during
implementation. Thus the production level code get ready with ease with the
help of these pseudo codes.

ROOM PSEUDOCODE 

BEGIN

	choosing between entering data or devices_states

	if ( chose to enter data )

THEN

		enter_the_weather_data();
...
ENTER_THE_WEATHER_DATA() PSEUDOCODE 

BEGIN

Take the weather data as input

Use the data from input to analyse and change state of devices

if ( changing the state of devices is successful )

THEN

	User will be prompted about that;
...
DEVICES_STATES() PSEUDOCODE 

BEGIN


Display all the devices, and the states of devices

if ( chose to edit devices )
...
EDIT_DEVICES() PSEUDOCODE 

BEGIN

if ( chose to remove a device )
...
THEN 
	...
	if( removing a device was unsuccessful )

THEN
 		
		return to edit devices;
...
ADD_DEVICE() PSEUDOCODE 

BEGIN

if ( chose to adding a device )

THEN 

select type of device to be added;
	enter the data of the device;

	if( adding a device was unsuccessful )
